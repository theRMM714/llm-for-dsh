 ...
 * Host's own catalog (`__LLM_COMPAT_CATALOG__`), so the page and the Host enforce
  ...
  factory: (require) => {
    ...
    try {
      ...
      function insertStyles() {
        ...
        const tagId = __LLM_COMPAT_PACKAGE__ + '/settings.css'
